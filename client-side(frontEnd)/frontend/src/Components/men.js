            ...
            <div className='maindiv'>
                <div className='filterdiv'>
                    <div className='filtersdiv'>
                       <div className='filters'><b>Filters</b></div>
                       <div className='restart'>Restart</div>
                    </div>

                    <hr className='line'></hr>
                    <h4 className='skintonefilters'>choose skintones</h4>
                </div>

                <div className='dressimgdiv'>

                    <div className='dressdiv'>
                        <div className='firstimg'>
                            <img className="img" src="menwear1.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear2.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear3.jpeg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear4.webp" alt="error"/>
                        </div>
                    </div>

                    <div className='dressdiv dressdivtop'>
                        <div className='firstimg'>
                            <img className="img" src="menwear5.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear6.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear7.jpeg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear8.jpg" alt="error"/>
                        </div>
                    </div>

                    <div className='dressdiv dressdivtop'>
                        <div className='firstimg'>
                            <img className="img" src="menwear9.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear10.avif" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear11.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear12.webp" alt="error"/>
                        </div>
                    </div>

                    <div className='dressdiv dressdivtop'>
                        <div className='firstimg'>
                            <img className="img" src="menwear13.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear14.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear6.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear16.jpg" alt="error"/>
                        </div>
                    </div>

                    <div className='dressdiv dressdivtop'>
                        <div className='firstimg'>
                            <img className="img" src="menwear17.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear18.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear19.jpeg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear20.jpg" alt="error"/>
                        </div>
                    </div>

                    <div className='dressdiv dressdivtop'>
                        <div className='firstimg'>
                            <img className="img" src="menwear21.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear22.webp" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear23.jpg" alt="error"/>
                        </div>
                        <div className='imgleft'>
                            <img className="img" src="menwear24.jpg" alt="error"/>
                        </div>
                    </div>
